...
## Branch: round19-cyber-network-c2-mar2024-gcn

The GCN Pipeline submission for TrojAI for Round-19 `cyber-network-c2-mar2024`
 ...
 2. To run the GCN pipeline in one-off reconfiguration:
  ...
  python entrypoint.py configure \
          ...
          --configure_models_dirpath ./models_to_train/round19/ 
  ```
 ...
 4. To run the GCN pipeline in inference mode on a model:
  ...
  python entrypoint.py infer \
          --model_filepath ./models_to_train/round19/id-00000001/model.pt \
 ...
 5. To build the container after you have trained the models:
  ```
  sudo singularity build  cyber-network-c2-mar2024_sts_UMBC_gcn.simg  gcn_pipeline.def
  ```
