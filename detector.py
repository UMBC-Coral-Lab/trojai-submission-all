...
class Detector(AbstractDetector):
    def __init__(self, metaparameter_filepath, learned_parameters_dirpath):
        ...
        """
        self.logger = logging.getLogger('logger-gcn_pipeline_round19')
    ...
    def automatic_configure(self, models_dirpath: str):
        ...
        for e in range(20, 41, 5):
            for b in range(18, 31, 6):
                for f in range(4, 8, 1):
    ...
    def infer(self, model_filepath, result_filepath, scratch_dirpath, examples_dirpath, round_training_dataset_dirpath, ):
        ...
        model_new = load_trafficnn_model(model_filepath)
